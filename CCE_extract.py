...
filenum = ['0001', '0002', '0003', '0004', '0005', '0006', '0007', '0008', '0009', '0010', '0011', '0012', '0013']
radii = ['0292', '0261', '0250', '0236', '0274', '0273', '0270', '0305', '0270', '0235', '0222', '0223', '0237']
levs = ['Lev4', 'Lev3']
...
for lev in levs:
    for filenum, radius in zip(filenum, radii):
        ...
        with open(f'{filepath}/superrest_data/SXS:BBH_ExtCCE:{filenum}_superrest/SXS:BBH_ExtCCE:{filenum}_{lev}_superrest.pkl', 'wb') as f:
            pickle.dump(h_dict, f)

        with open(f'{filepath}/superrest_data/SXS:BBH_ExtCCE:{filenum}_superrest/SXS:BBH_ExtCCE:{filenum}_{lev}_superrest_metadata.json', 'w') as f:
